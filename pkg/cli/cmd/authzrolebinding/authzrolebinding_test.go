...
func TestNewAuthzRoleBindingCmd_Structure(t *testing.T) {
	cmd := NewAuthzRoleBindingCmd()
...
func TestAuthzRoleBindingCmd_GetAndDeleteRequireArg(t *testing.T) {
	cmd := NewAuthzRoleBindingCmd()
...
func TestAuthzRoleBindingCmd_NamespaceFlag(t *testing.T) {
	cmd := NewAuthzRoleBindingCmd()
