...
func TestNewClusterWorkflowPlaneCmd_Structure(t *testing.T) {
	cmd := NewClusterWorkflowPlaneCmd()
...
func TestClusterWorkflowPlaneCmd_GetAndDeleteRequireArg(t *testing.T) {
	cmd := NewClusterWorkflowPlaneCmd()
...
func TestClusterWorkflowPlaneCmd_NoNamespaceFlag(t *testing.T) {
	cmd := NewClusterWorkflowPlaneCmd()
