...
func TestNewWorkflowPlaneCmd_Structure(t *testing.T) {
	cmd := NewWorkflowPlaneCmd()
...
func TestWorkflowPlaneCmd_GetAndDeleteRequireArg(t *testing.T) {
	cmd := NewWorkflowPlaneCmd()
...
func TestWorkflowPlaneCmd_NamespaceFlag(t *testing.T) {
	cmd := NewWorkflowPlaneCmd()
