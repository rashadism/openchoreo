...
func TestE2ENetworkPolicy(t *testing.T) {
	RegisterFailHandler(Fail)
	fmt.Fprintf(GinkgoWriter, "Starting OpenChoreo network policy e2e suite\n")
	RunSpecs(t, "OpenChoreo E2E NetworkPolicy Suite")
}
