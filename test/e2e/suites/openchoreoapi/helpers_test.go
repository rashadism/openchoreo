...
// newUnauthClient creates a gen.ClientWithResponses without a Bearer token.
...
// (HTTP Basic auth). The service_mcp_client is configured for this method, which
// differs from the client_secret_post method used by framework.FetchClientCredentialsToken.
