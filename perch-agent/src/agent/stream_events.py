...
class ActionsEvent(_StreamEventBase):
    """Proposed write actions promoted into the action store. The UI
    renders each entry as a confirm card; on Approve the UI POSTs the
    action_id to /execute."""
...
StreamEvent = Annotated[
    Union[MessageChunkEvent, ToolCallEvent, ActionsEvent, DoneEvent, ErrorEvent],
