...
type AddonSpec struct {
	...
	// +optional
	Creates []runtime.RawExtension `json:"creates,omitempty"`
...
type AddonSchema struct {
	...
	// EnvOverrides can be overridden per environment via EnvSettings.
...
// +kubebuilder:resource:scope=Cluster,shortName=addon;addons
