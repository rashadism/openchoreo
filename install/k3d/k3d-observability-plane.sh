...
#   curl -sL https://raw.githubusercontent.com/openchoreo/openchoreo/release-v1.1/install/k3d/k3d-observability-plane.sh | bash
#
...
OPENCHOREO_OP_VERSION="${OPENCHOREO_OP_VERSION:-1.1.x}"  # overridable via env; latest 1.1 patch
