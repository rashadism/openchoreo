...
- **(Platform Observability)** Logs for OpenChoreo's own system components: a platform logs query endpoint and filter-value API in the Observer, an `occ` command and MCP tool to query them, platform identity labels stamped on system pods, and a centralized Platform Logs dashboard in the portal. ([#4658](https://github.com/openchoreo/openchoreo/pull/4658), [#4719](https://github.com/openchoreo/openchoreo/pull/4719), [#4725](https://github.com/openchoreo/openchoreo/pull/4725), [#4741](https://github.com/openchoreo/openchoreo/pull/4741), [#4636](https://github.com/openchoreo/openchoreo/pull/4636), [#784](https://github.com/openchoreo/backstage-plugins/pull/784), [#787](https://github.com/openchoreo/backstage-plugins/pull/787))
...
- **(Backstage UI)** A composable home page with a customizable widget grid and config-driven predefined cards. ([#794](https://github.com/openchoreo/backstage-plugins/pull/794), [#714](https://github.com/openchoreo/backstage-plugins/pull/714))
- **(Backstage UI)** Portal packaging and rebranding: portal-backend and portal-app extracted as their own packages, an `app.branding` config for rebranding, the deployed OpenChoreo version surfaced in the console, and packages published to public npm via trusted publishing. ([#707](https://github.com/openchoreo/backstage-plugins/pull/707), [#708](https://github.com/openchoreo/backstage-plugins/pull/708), [#722](https://github.com/openchoreo/backstage-plugins/pull/722), [#771](https://github.com/openchoreo/backstage-plugins/pull/771))
...
- **(Gateway)** Cluster gateway high availability, plus X-Forwarded-Client-Cert support for cluster gateway agent authentication. ([#4580](https://github.com/openchoreo/openchoreo/pull/4580), [#4340](https://github.com/openchoreo/openchoreo/pull/4340))
...
- **(Observability)** Module coverage broadened: HTTP metrics and runtime topology, a Google Cloud Trace tracing module, X-Ray span status messages, optional TLS for OpenObserve connections, and Prometheus and Alertmanager data persisted on PVCs by default. ([#323](https://github.com/openchoreo/community-modules/pull/323), [#326](https://github.com/openchoreo/community-modules/pull/326), [#386](https://github.com/openchoreo/community-modules/pull/386), [#381](https://github.com/openchoreo/community-modules/pull/381), [#420](https://github.com/openchoreo/community-modules/pull/420))
- **(API)** Network and disk I/O fields added to the resource metrics contract. ([#4497](https://github.com/openchoreo/openchoreo/pull/4497))
- **(Install)** Observability module chart versions are pinned at release time, with the installation scripts and patch release process updated to match. ([#4758](https://github.com/openchoreo/openchoreo/pull/4758), [#4765](https://github.com/openchoreo/openchoreo/pull/4765))
- **(Resources)** The url-shortener sample migrated to a Resource. ([#4081](https://github.com/openchoreo/openchoreo/pull/4081))
