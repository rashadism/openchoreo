...
# the user's per-tool MCP permissions. Fine-grained checks happen per-tool in
# the openchoreo MCP layer.
require_invoke_authz = AuthorizationChecker(
    action="portal-assistant:invoke", resource_type="portal-assistant"
)
