...
WORKFLOW_TEMPLATE_FILES := \
	...
	$(WORKFLOW_TEMPLATE_DIR)/docker.yaml \
	$(WORKFLOW_TEMPLATE_DIR)/react.yaml \
	$(WORKFLOW_TEMPLATE_DIR)/ballerina-buildpack.yaml \
	$(WORKFLOW_TEMPLATE_DIR)/google-cloud-buildpacks.yaml
...
workflow-templates-gen: ## Generate samples/getting-started/workflow-templates.yaml from individual files
	...
	@{ \
	printf '# OpenChoreo Build Plane Workflow Templates\n'; \
	printf '#\n'; \
	printf '# This file is auto-generated by "make workflow-templates-gen". DO NOT EDIT.\n'; \
	printf '#\n'; \
	printf '# Contains the coordinator ClusterWorkflowTemplates (docker, react,\n'; \
	printf '# ballerina-buildpack, google-cloud-buildpacks) and the generate-workload\n'; \
	printf '# template. checkout-source and publish-image are applied separately\n'; \
	printf '# so they can be replaced independently.\n'; \
	printf '#\n'; \
	printf '# Usage:\n'; \
