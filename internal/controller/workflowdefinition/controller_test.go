...
var _ = Describe("WorkflowDefinition Controller", func() {
	Context("When reconciling a resource", func() {
		...
		workflowdefinition := &openchoreodevv1alpha1.WorkflowDefinition{}
		...
		AfterEach(func() {
			...
			By("Cleanup the specific resource instance WorkflowDefinition")
