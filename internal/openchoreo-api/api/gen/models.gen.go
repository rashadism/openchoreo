...
type ClusterComponentTypeSpec struct {
	...
	// EnvironmentConfigs Schema section supporting either ocSchema or openAPIV3Schema format (mutually exclusive)
	EnvironmentConfigs *SchemaSection `json:"environmentConfigs,omitempty"`

	// Parameters Schema section supporting either ocSchema or openAPIV3Schema format (mutually exclusive)
...
// SchemaSection Schema section supporting either ocSchema or openAPIV3Schema format (mutually exclusive)
type SchemaSection struct {
	// OcSchema Schema using OpenChoreo's simple schema format. May contain $types for reusable type definitions.
	OcSchema *map[string]interface{} `json:"ocSchema,omitempty"`
