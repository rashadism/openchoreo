...
const (
	...
	SystemActionViewDataPlaneResource          systemAction = "dataplaneresource:view"
	SystemActionViewBuildPlaneResource         systemAction = "buildplaneresource:view"
	SystemActionViewObservabilityPlaneResource systemAction = "observabilityplaneresource:view"
)
...
const (
	...
	ResourceTypeObservabilityPlaneResource ResourceType = "observabilityPlaneResource"
)
