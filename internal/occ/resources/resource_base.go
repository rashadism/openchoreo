...
import (
	...
	occClient "github.com/openchoreo/openchoreo/internal/occ/resources/client"
...
func WithResourceAPIClient(apiClient *occClient.APIClient) ResourceBaseOption {
	return func(base *ResourceBase) {
...
func (base *ResourceBase) ApplyTypedResource(obj interface{}) error {
	...
	if apiClient == nil {
		apiClient, err = occClient.NewAPIClient()
		if err != nil {
