...
func TestNewWorkloadResource(t *testing.T) {
	t.Run("with namespace", func(t *testing.T) {
		wr, err := NewWorkloadResource(constants.WorkloadV1Config, "my-ns")
		require.NoError(t, err)
		require.NotNil(t, wr)
		assert.Equal(t, "my-ns", wr.GetNamespace())
		assert.Equal(t, constants.WorkloadV1Config, wr.GetConfig())
	})

	t.Run("without namespace", func(t *testing.T) {
		wr, err := NewWorkloadResource(constants.WorkloadV1Config, "")
		require.NoError(t, err)
		require.NotNil(t, wr)
...
func TestCreateWorkload_Validation(t *testing.T) {
	...
	err = wr.CreateWorkload(api.CreateWorkloadParams{
