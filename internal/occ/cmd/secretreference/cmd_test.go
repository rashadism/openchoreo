...
// --- NewSecretReferenceCmd structure ---

func TestNewSecretReferenceCmd_Use(t *testing.T) {
	cmd := NewSecretReferenceCmd(errFactory("unused"))
	assert.Equal(t, "secretreference", cmd.Use)
	assert.Contains(t, cmd.Aliases, "sr")
	assert.Contains(t, cmd.Aliases, "secretreferences")
}

func TestNewSecretReferenceCmd_Subcommands(t *testing.T) {
	cmd := NewSecretReferenceCmd(errFactory("unused"))
...
func TestListCmd_Success(t *testing.T) {
	...
	mc.EXPECT().ListSecretReferences(mock.Anything, mock.Anything, mock.Anything).Return(&gen.SecretReferenceList{
		Items:      []gen.SecretReference{{Metadata: gen.ObjectMeta{Name: "my-secret"}}},
...
func TestGetCmd_Success(t *testing.T) {
	...
	mc.EXPECT().GetSecretReference(mock.Anything, mock.Anything, "my-secret").Return(
		&gen.SecretReference{Metadata: gen.ObjectMeta{Name: "my-secret"}}, nil,
	)
...
func TestDeleteCmd_MissingArg(t *testing.T) {
	...
	err := cmd.Args(cmd, []string{})
	require.Error(t, err)
	assert.Contains(t, err.Error(), "SECRET_REFERENCE_NAME")
}
...
func TestDeleteCmd_Success(t *testing.T) {
	mc := mocks.NewMockInterface(t)
	mc.EXPECT().DeleteSecretReference(mock.Anything, mock.Anything, "my-secret").Return(nil)
