...
```bash
kubectl apply -f https://raw.githubusercontent.com/openchoreo/openchoreo/release-v1.2/samples/from-source/web-apps/react-starter/react-web-app.yaml
```
...
```bash
kubectl delete -f https://raw.githubusercontent.com/openchoreo/openchoreo/release-v1.2/samples/from-source/web-apps/react-starter/react-web-app.yaml
```
