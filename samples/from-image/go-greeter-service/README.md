...
```bash
kubectl apply -f https://raw.githubusercontent.com/openchoreo/openchoreo/release-v1.2/samples/from-image/go-greeter-service/greeter-service.yaml
```
...
```bash
kubectl delete -f https://raw.githubusercontent.com/openchoreo/openchoreo/release-v1.2/samples/from-image/go-greeter-service/greeter-service.yaml
```
